...
**Meta-Hybrid Mount** is a next-generation hybrid mount metamodule designed for KernelSU. Written in native Rust, it orchestrates multiple mounting strategies— **OverlayFS** and **Magic Mount**—to provide the ultimate module management experience with superior performance, stability, and stealth.
